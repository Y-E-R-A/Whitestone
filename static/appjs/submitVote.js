angular.module('Whitestone').controller('submitVoteController', ['$http', '$log', '$scope', '$location', '$routeParams', 'authenticationSvc',
    function ($http, $log, $scope, $location, $routeParams, authenticationSvc) {
        ...
        //Value that stores the user's selected choice        
        this.selectedChoice = [];
        ...
        this.checkChoice = function (choice) {
            ...
            //If the choice has already been selected, then remove it from
            //the list. Else Add it to the list
            ...
            $http.get(reqURL).then(
                ...
                function (response) {
                    ...
                    if (status == 0) {
                        ...
                        //meeting does not exist, hide all html elements
